...
def main() -> int:
    ...
    # The pinned upstream leaves wandb unbounded. In 2026 this resolves to a much
    # newer W&B build whose generated telemetry protobufs are incompatible with
    # the protobuf 3.20.x line required by the TensorFlow 2.15 / TFDS runtime.
    probe._run_stage(
